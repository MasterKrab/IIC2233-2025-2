...
class Servidor:
    ...
    def aceptar_clientes(self) -> None:
        ...
        while True:
            ...
            self.clientes[id_cliente] = (socket_cliente, adress)
    ...
    def recibir_mensaje(self, id_cliente: int) -> Mensaje:
        ...
        """
        # TODO: Parte III
        data = self.clientes[id_cliente][0].recv(8000)
    ...
    def enviar_mensaje(self, id_cliente: int, mensaje: Mensaje) -> bytes:
        ...
        self.clientes[id_cliente][0].sendall(data)
        return data
    ...
    def desconectar_cliente(self, id_cliente: int) -> None:
        ...
        """
        # TODO: Parte II
        self.clientes[id_cliente][0].close()
    ...
    def cargar_transacciones(self) -> None:
        ...
        """
        # TODO: Parte I
        with open(self.path_transacciones, encoding="utf-8") as file:
            self.transacciones = json.load(file)
    ...
    def guardar_transacciones(self) -> None:
        ...
        with open(self.path_transacciones, "w", encoding="utf-8") as file:
    ...
    def agregar_transaccion(
        self, prestador: str, deudores: list, gasto_total: int
    ) -> None:
        """
